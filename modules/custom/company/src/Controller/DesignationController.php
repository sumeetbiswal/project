...
class DesignationController extends ControllerBase {
  public function Designationcontent() {
    ...
    foreach ($result as $row => $content) {
      ...
      $rows[] = array('data' =>  array( $sl, $content->codevalues, $content->codename, $dept->codevalues, render($html))
      );
    }
    $element['display']['Designationlist'] = array(
      ...
      '#prefix'     => '<div class="panel panel-info">
                        ...
                        <div class=" col-md-2"> <a href="#" id="exportit" data-toggle="tooltip" data-original-title="Word Document"><img src="'.$asset_url.'/assets/images/icon/word.png" /></a> &nbsp;
