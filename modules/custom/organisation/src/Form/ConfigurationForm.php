...
class ConfigurationForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['organisation']['Departmentcode'] = [
      '#type' => 'checkbox',
    ...
    $form['organisation']['Designationcode'] = [
      '#type' => 'checkbox',
    ...
    $form['organisation']['Workordercode'] = [
      '#type' => 'checkbox',
